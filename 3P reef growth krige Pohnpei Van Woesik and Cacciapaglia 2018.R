...
# writeRaster(Pmsk1,'Pohn_outer.nc',overwrite=TRUE)
# writeRaster(Pmsk2,'Pohn_inner.nc',overwrite=TRUE)
# writeRaster(Pmsk3,'Pohn_patch.nc',overwrite=TRUE)
# # 
...
tiff('Pohnpei Fishes erosion krige FINALtest.png',width=541*sz,height=530*sz, res = 300)
...
text(158.1179,7.03961,'Parrot fish erosion',col='white')
...
scalebar(d=3,c(158.3318,7.022558),col='white',label='5 km',divs=2,)
