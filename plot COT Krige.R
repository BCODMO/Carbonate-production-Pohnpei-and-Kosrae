...
setwd("F:/ACCRETION OF REEFS/Accretion model 2018/Accretion Pohnpei Kosrae 2018/Kosrae/Shapefiles") #where you get files
reefs<-readOGR(".",'Kosrae reefs')
savef<-"F:/ACCRETION OF REEFS/Accretion model 2018/Accretion Pohnpei Kosrae 2018/Kosrae/" #where you want to save the stuff
...
setwd("F:/ACCRETION OF REEFS/Accretion model 2018/Accretion Pohnpei Kosrae 2018/Kosrae")


Ppts <- read_csv("Kosrae site model COT3.csv",col_types = cols(X1 = col_skip()))
...
writeRaster(Pmsk1,'outerNPCOT.nc')
writeRaster(Pmsk2,'innerNPCOT.nc')
# writeRaster(Pmsk3,'patch.nc')
# 


Pmsk1<-raster('outerNPCOT.nc')
Pmsk2<-raster('innerNPCOT.nc')
...
PptsLL <- read_csv("Kosrae site model COT3.csv",col_types = cols(X1 = col_skip()))
coordinates(PptsLL)<- ~palsites.real.lon+palsites.real.lat
...
tiff('Kosrae net reef accretion krige COTtest.png',width=788*sz,height=635*sz, res = 300)
...
compassRose(162.895,5.27,col='white',cex=.8)
color.legend(162.9009,5.366731,162.9409,5.371731,legend=round(seq(0,range(allr)[2],length.out=5),0), rect.col=cols,cex=1,col='white')
#image(ppatch,add=T,col=cols,zlim=range(allr),colorbar=F)
image(pouter,add=T,col=cols,zlim=range(allr),colorbar=F)
text(162.9209,5.363731,'Net carbonate production',col='white')
...
points(162.9,5.348,cex=5/1.5+.4,lwd=3,col='white')
points(162.9,5.348,cex=5/1.5,pch=1,lwd=3,col='black')

points(162.9,5.34,cex=3/1.5+.4,lwd=3,col='white')
points(162.9,5.34,cex=3/1.5,pch=1,lwd=3,col='black')

points(162.9,5.332,cex=1/1.5+.4,lwd=3,col='white')
points(162.9,5.332,cex=1/1.5,pch=1,lwd=3,col='black')

text(162.92,5.348,expression(paste("-5 kg CaCO"[3],' ',m^-2,' ',yr^-1)),cex=.8,col='white')
text(162.919,5.34,expression(paste("-3 kg CaCO"[3],' ',m^-2,' ',yr^-1)),cex=.8,col='white')
text(162.918,5.3325,expression(paste("-1 kg CaCO"[3],' ',m^-2,' ',yr^-1)),cex=.8,col='white')
