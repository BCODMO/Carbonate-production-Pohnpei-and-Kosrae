...
#########################################
setwd("E:/ACCRETION OF REEFS/Accretion model 2018/Accretion Pohnpei Kosrae 2018/Figures/Pohnpei")
pouter<-raster('Pohn_outer.nc')
pinner<-raster('Pohn_inner.nc')
ppatch<-raster('Pohn_patch.nc')
...
tiff('Pohnpei net reef accretion krige2.png',width=541*sz,height=530*sz, res = 300)
